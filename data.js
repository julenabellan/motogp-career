...
const TEAMS = {
  ...
  Supersport: [
    { name: "ZXMoto Factory Evan Bros Racing",       strength: 69, color: "#5981bc", logo: "ZXmoto"         },
    ...
    { name: "AS bLU cRU Racing Team",                 strength: 72, color: "#1E88E5", logo: "ASracing"       },
    { name: "PTR Triumph Factory Racing",             strength: 74, color: "#efff00", logo: "Triumph"        },
    { name: "QJMOTOR Factory Racing",                 strength: 70, color: "#792024", logo: "QJ"             },
    { name: "Kawasaki WorldSSP Team",                 strength: 73, color: "#59c84a", logo: "Kawasaki"       },
    { name: "Honda Racing WorldSSP Team",             strength: 73, color: "#cc1517", logo: "HRC"            },
    { name: "Orelac Racing Verdnatura",               strength: 73, color: "#e56042", logo: "Orelac"         },
    { name: "Feel Racing WorldSSP Team",              strength: 71, color: "#ff2f00", logo: "Feel"           },
    { name: "Cerba Yamaha Racing Team",               strength: 68, color: "#21409a", logo: "Cerba"          },
    { name: "WRP Racing",                             strength: 70, color: "#efff00", logo: "WRP"            },
    { name: "Althea Racing Team",                     strength: 72, color: "#313131", logo: "Althea"            },
    { name: "Motozoo Racing MV Agusta",                     strength: 68, color: "#313131", logo: "Motozoo"            },
    { name: "VFT Racing Yamaha",                     strength: 68, color: "#21409a", logo: "VFT"            },
    { name: "Renzi Corse",                     strength: 68, color: "#ee332e", logo: "Renzi"            },
  ],
  ...
  SportBike: [
    ...
    { name: "Wixx Racing Suzuki",        strength: 49, color: "#ce0012", logo: "WixxSuzuki" },
    { name: "Nitiracing Yamaha",        strength: 47, color: "#21409a", logo: "Niti" },
    { name: "Team BrCorse Yamaha",        strength: 47, color: "#21409a", logo: "BrCorse" },
    { name: "Pons Motosport Italika Racing",        strength: 44, color: "#21409a", logo: "Pons" },
  ],
